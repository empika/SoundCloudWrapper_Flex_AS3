	...
	*/
	public class OAuthRequest
	{
		...
		*/
		 ...
		 * @private
		*/
		public function setRequestParam(strKey: String, strVal: String ):void {
				_requestParams[strKey] = strVal;
				trace("set token");
		}
				...
				case RESULT_TYPE_HEADER:
					...
					for (param in _requestParams) {
						...
						if (param.toString().indexOf("oauth") == 0) {
							data += comma + param + "=\"" + URLEncoding.encode(_requestParams[param]) + "\"";
						}
						count++;
					}
